    ...
    public class Reusable_Methods_Reports {
        ...
        public static void click(WebDriver driver, String locator,ExtentTest logger, String elementName) throws IOException, InterruptedException {
            ...
            try{
                ...
                logger.log(LogStatus.INFO,"Unable to click on element - " + elementName + e);
                getScreenshot(driver,logger,elementName);
            }
        }//end of click method

        //method to submit on an element
        public static void submit(WebDriver driver, String locator,ExtentTest logger,String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
        ...
        public static void clickByMouse(WebDriver driver,ExtentTest logger, String locator, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            ...
            try{
                //Thread.sleep(1500);
                System.out.println("Clicking on element " + elementName);
                logger.log(LogStatus.FAIL,"Clicking on element " + elementName);
        ...
        public static void clickByIndex(WebDriver driver, String locator,ExtentTest logger, int indexNum, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
                System.out.println("Clicking on element " + elementName + " by index number " + indexNum);
                logger.log(LogStatus.FAIL,"Clicking on element " + elementName + " by index number " + indexNum);
                ...
                logger.log(LogStatus.FAIL,"Unable to click on element - " + elementName + " by index number... " + e);
                getScreenshot(driver,logger,elementName);
            }
        ...
        public static void mouseHover(WebDriver driver, String locator,ExtentTest logger, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            Actions mouseAction = new Actions(driver);
            try{
                ...
                logger.log(LogStatus.FAIL,"Hovering on element " + elementName);
                WebElement element = driver.findElement(By.xpath(locator));
        ...
        public static void type(WebDriver driver, String locator,ExtentTest logger, String userValue,String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
        ...
        public static void typeByIndex(WebDriver driver, String locator,ExtentTest logger, String userValue, int indexNum, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
                System.out.println("Entering " + userValue + " on element " + elementName + " by index number " + indexNum);
                logger.log(LogStatus.FAIL,"Entering " + userValue + " on element " + elementName + " by index number " + indexNum);
                ...
                logger.log(LogStatus.FAIL,"Unable to enter keyword on element - " + elementName + " by index number... " + e);
                getScreenshot(driver,logger,elementName);
            }
        ...
        public static void typeUsingMouse(WebDriver driver, String locator,ExtentTest logger, String userValue, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            Actions mouseAction = new Actions(driver);
            try{
                //Thread.sleep(1500);
                System.out.println("Entering " + userValue + " on element " + elementName);
                logger.log(LogStatus.FAIL,"Entering " + userValue + " on element " + elementName);
        ...
        public static void dropDownSelect(WebDriver driver, String locator,ExtentTest logger, String dropdownValue, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
                System.out.println("Selecting " + dropdownValue + " from drop down " + elementName);
                logger.log(LogStatus.FAIL,"Selecting " + dropdownValue + " from drop down " + elementName);
                WebElement element = driver.findElement(By.xpath(locator));
        ...
        public static void verifyText(WebDriver driver, String locator,ExtentTest logger, String expectedText, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
                ...
                if(expectedText.equals(actualtext)){
                    ...
                    logger.log(LogStatus.FAIL,"Text verification matches for " + elementName);
                } else {
                    System.out.println("Expected doesn't match actual and actual text is " + actualtext);
                    logger.log(LogStatus.FAIL,"Expected doesn't match actual and actual text is " + actualtext);
                }
            } catch (Exception e) {
        ...
        //method to capture and return text from a webElement
        public static String captureTextByIndex(WebDriver driver, String locator,ExtentTest logger, int indexNum, String elementName) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            String textElement = null;
            try{
        ...
        public static void verifyPageTitle(WebDriver driver,ExtentTest logger,String expectedTitle) throws IOException, InterruptedException {
            //for explicit use WebDriverWait command
            WebDriverWait wait = new WebDriverWait(driver,timeout);
            try{
                //Thread.sleep(1500);
                System.out.println("Verifying page expected title on");
                logger.log(LogStatus.INFO,"Verifying page expected title on" );
                String actualTitle = driver.getTitle();
                if(actualTitle.contains(expectedTitle)){
                    System.out.println("Title matches for - " + expectedTitle);
                    logger.log(LogStatus.INFO,"Title matches for - "+expectedTitle);
                } else {
                    System.out.println("Expected doesn't match actual and actual title is " + actualTitle);
                    logger.log(LogStatus.INFO,"Expected doesn't match actual and actual title is " + actualTitle);
                }
            } catch (Exception e) {
                System.out.println("Unable to get page title - " + e);
                logger.log(LogStatus.FAIL,"Unable to get page title - " + e);
                getScreenshot(driver,logger,"Unable to Get page title - "+e);
            }
